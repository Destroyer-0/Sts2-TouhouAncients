...
| `talk.IRONCLAD.0-0r.ancient` | 那个你能表演一下那个吗对就是那个“黑拥重振放干血条重放恶魔之火最后牌烧完了我打什么？”！ | Hey, can you do that thing, yeah that thing—"Dark Embrace + Corruption + Dropkick + Replay Demon Form, and then all my cards are exhausted, what do I play?!" |
...
| `talk.ANY.0-0r.ancient` | 赶紧去把塔顶的麻烦解决掉吧，我才能让[u]那家伙[/u]放我回幻想乡去喝茶。 | Hurry up and deal with the trouble at the top so [u]she’ll let me go back to Gensokyo for some tea. |
...
| `talk.ANY.4-0r.ancient` | 这种破地方，除了烦人的虫子和叽叽喳喳的蓝鸟怪人根本没多少参拜客，完全收不到什么香火钱嘛。 | A rundown place like this barely gets any worshippers—just annoying bugs and a chattering blue bird freak. I can barely scrape together any offering money at all. |
...
| `talk.ANY.2-0r.ancient` | 又有客人来参加我的茶会了。咲夜，记得多准备一份呐。 | Another guest for my tea party. Sakuya, remember to prepare an extra serving. |
...
| `talk.SILENT.0-1.char` | …… | ... |
| `talk.SILENT.0-1.next` | 继续 | Continue |
| `talk.SILENT.0-2.ancient` | 你和吸血鬼的相性貌似不错，不过力量还差了一些，要不要带走点什么宝物呢？ | Your compatibility with vampires seems quite good, but you are still lacking in power. Would you like to take a treasure with you? |
...
| `talk.REGENT.0-1r.ancient` | 在这里这是理所当然的吧？ | That is only natural here, is it not? |
...
| `talk.NECROBINDER.1-0r.ancient` | 哎呀，好久不见！我们家的帕琪很想你呢，呵呵。 | Oh my, long time no see! Pache has missed you, heheh. |
...
| `talk.NECROBINDER.1-3r.ancient` | 作为和我们家帕琪聊天的谢礼，就带上这个吧。 | As thanks for chatting with Pache, take this with you. |
...
| `.epithet` | 荒疫也为之惧怯的少女 | The Maiden Whom Even the Blight Fears |
...
| `talk.ANY.1-0r.ancient` | 天界的生活太无聊了，看着你们爬塔的样子，看着看着自己也想进塔了啊！ | Life in the heavens is so boring. Watching you all slay the spire makes me want to go in myself! |
...
| `talk.SILENT.0-1.char` | …… | ... |
| `talk.SILENT.0-1.next` | 继续 | Continue |
| `talk.SILENT.0-2.ancient` | 但是呢，我认识的人里也有做药的高手。别说是毒药，所有的药都能做。呵呵，下次有机会介绍给你吧？ | Well, I know someone who’s a master at making medicine. Not just antidotes—they can make any kind of drug. Heheh, shall I introduce you sometime? |
...
| `talk.ANY.10-0r.ancient` | 特兹卡塔拉老奶奶的热可可和饼干的味道都很不错——可惜我是和食主义者Da☆Ze！。 | Granny Tezcatara’s hot cocoa and cookies were pretty good—too bad I’m a Washoku-ist Da☆Ze! |
...
| `talk.DEFECT.0-0.ancient` | 一个机器人？想要修好你的朋友？恩……我有个认识的家伙就是个[aqua]机械工程师[/aqua]，说不定能帮上忙Da☆Ze！ | A robot? Want to fix your friend? Hmm... I know someone who’s an [aqua]mechanical engineer[/aqua]. Maybe she can help Da☆Ze! |
| `talk.DEFECT.1-0r.ancient` | [aqua]荷取[/aqua]那家伙也不知道在忙什么……总之有机会的话，我会把你介绍给她的啦。 | That [aqua]Nitori[/aqua], who knows what she’s busy with... Anyway, if I get the chance, I’ll introduce you to her. |
...
| `talk.ANY.1-0r.ancient` | 一次又一次地尝试登上永无止境的塔顶，说不定也挺有趣的……呵呵。 | Endlessly trying to reach the top of the tower, over and over again... that might be rather amusing too... heheh. |
...
| 对话键 | 中文 | English |
|--------|------|---------|
| `talk.firstVisitEver.0-0.ancient` | 这个角色还在制作中！ | This character is still in development! |
| `talk.ANY.0-0r.ancient` | 这个角色还在制作中！ | This character is still in development! |
...
| `talk.ANY.1-0r.ancient` | 我与月之民之间的交战陷入了僵局，最近也正为此感到厌倦了，来这里倒是个不错的选择呢。 | My conflict with the Lunarians has reached a stalemate anyway. I’ve grown weary of it lately—coming here is actually not a bad choice. |
...
| `talk.REGENT.0-1.next` | 继续 | Continue |
| `talk.REGENT.0-2.ancient` | 呵！无趣的借口！我会等到你的小人们推翻你的那一刻到来的！ | Hah! Boring excuse! I’ll be here waiting for the day your little people overthrow you! |
...
| `talk.DEFECT.0-1.char` | [i][font_size=22]<疑惑的嘀嘀声>[/font_size][/i] | [i][font_size=22]<Confused beep>[/font_size][/i] |
| `talk.DEFECT.0-1.next` | 继续 | Continue |
| `talk.DEFECT.0-2.ancient` | 居然是个有自主意识的家伙……看来关于构装体的付丧神化是个不错的研究方向。 | So it has a will of its own... It seems tsukumogami-fication of constructs is a promising research direction. |
| `talk.DEFECT.1-0r.ancient` | 修好你？哼，以前那些靠我的魔力才醒过来的[jitter]道具[/jitter]，得到自己的身体后二话不说就溜了还反过来追杀我！我才不上当呢！ | Repair you? Hmph, there were once [jitter]tools[/jitter] that woke up thanks to my magic, got their own bodies, and immediately ran off—then came back to hunt me! I’m not falling for that again! |
...
| 字段 | 中文 | English |
|------|------|---------|
| `.title` | 依神 女苑&依神 紫苑 | Joon Yorigami & Shion Yorigami |
...
| `talk.ANY.1-0r.ancient` | 最幸福的人生当然就是[jitter][gold]什么东西都能买得起[/gold][/jitter]的土豪生活了！你说对吗？ | The most fulfilling of lives is that in which you can [jitter][gold]buy anything![/gold][/jitter] Do you agree? |
| `talk.ANY.1-0r.speaker` | jyoon | jyoon |
| `talk.ANY.1-0r.next` | 继续 | Continue |
| `talk.ANY.1-1r.ancient` | 如果你不同意，我会非常失望的看着你的…… | If you don’t agree, I will stare at you with a look of extreme disappointment... |
...
| `talk.IRONCLAD.0-0.next` | 继续 | Continue |
| `talk.IRONCLAD.0-1.ancient` | 姐姐你在担心什么？只要用那招的话……就没有打不败的家伙。 | Sis, what are you worried about? As long as we use that trick... there’s nobody we can’t beat. |
...
| `talk.ANY.4-0r.ancient` | 作为[jitter]未来的畜生界之王[/jitter]，让你安全通过这里并得到刚欲同盟的支援，可是你莫大的荣幸哦？呵呵呵。 | As the [jitter]future King of the Beast Realm[/jitter], allowing you safe passage and Gouyoku Alliance’s support is your great honor, ya know? Heheheh. |
...
| `talk.ANY.7-0r.ancient` | 这趟旅途能给月都万象展增加不少帮助呢。啊呀，是不是月都的东西对幻想乡的人来说也不重要吧。 | I could add what I’ve gathered here to the Lunar Capital’s Banquet of Diversity. It’s not like Gensokyo folks can tell what’s actually from the Lunar anyway. |
...
| `talk.NECROBINDER.1-0r.ancient` | 啊呀，何必那么着急？进来坐会儿吧，我让因幡去泡茶。 | Oh my, why the rush? Come in and sit for a while. I’ll have Inaba brew some tea. |
| `talk.NECROBINDER.1-0r.next` | 继续 | Continue |
...
| `talk.DEFECT.1-1r.char` | [i][font_size=22]<欣喜的嘀嘀……[/font_size][/i] | [i][font_size=22]<Joyful beep>[/font_size][/i] |
| `talk.DEFECT.1-1r.next` | 继续 | Continue |
| `talk.DEFECT.1-2r.ancient` | 哎呀，别那么着急，欲速则不达………| My, don't be so impatient. Haste makes waste... |
| `talk.DEFECT.2-0r.ancient` | 啊呀，你是来问进展的吧？反正时间有的是……明天再看也来得及的吧。公主之躯，岂能劳碌……（哈欠） | Oh my, here to ask about progress? We’ve got plenty of time anyway... Tomorrow will be soon enough, won’t it? |
...
| 键 | 中文 | English |
|------|------|---------|
| `talk.BG_KOAKUMA_CHARACTER_BG_KOAKUMA_CHARACTER.0-0.ancient` | 小恶魔？你在这里做什么？难怪帕琪找不到你。啊——你不会是要去塔顶吧？ | Koakuma? What are you doing here? No wonder Pache couldn't find you. Ah—you're not heading for the top of the tower, are you? |
...
| `talk.MOKOUMOD-MOKOU_MOD.0-3.char` | [jitter]（幻想乡粗口）在那之前，我会先把你烧成灰！！！！[/jitter] | [jitter]***, Before that, I'll burn you to ashes first!!!![/jitter] |
...
> **专有名词**：「幻想乡粗口」→ ***（用户指定直译）；「妹红」→ Mokou（台词中用名，无全名）。
